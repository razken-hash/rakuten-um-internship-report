\section{Development of a Proxy for Google Cloud Storage}
\label{sec:gcs-proxy}

\subsection{Context}
\acf{CI} pipelines automatically generate numerous artifacts such as tests, code coverage and static analysis reports. These artifacts are essential for validating software quality and approving \acs{PR} throughout the development lifecycle.
