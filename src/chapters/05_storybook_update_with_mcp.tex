...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../assets/storybook_upgrade/products-no-mcp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../assets/storybook_upgrade/products-mcp.png}
