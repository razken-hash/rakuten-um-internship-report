...
\begin{itemize}
    ...
    \item \textbf{Preview:} The preview environment is used to validate new features and changes before their integration into the main codebase. It provides developers and reviewers with an environment close to production, making it possible to verify the behavior of a change before its official release.
