...
Alongside the Next.js-based ecosystem, Rakuten France also maintains \lstinline|hypernova-common-services|, which provides an \acs{API} for \acs{SSR} of React components. This API is used by both the \lstinline|monolithic| application and \lstinline|price-mobile|.
