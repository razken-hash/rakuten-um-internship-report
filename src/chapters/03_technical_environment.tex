...
The frontend development ecosystem at Rakuten France has evolved from a monolithic architecture to a modern and robust technology stack designed to meet the demands of a large-scale e-commerce platform. This ecosystem emphasizes scalability, maintainability, performance, and developer productivity, while facilitating collaboration across distributed teams. It provides a reliable development workflow covering the entire software lifecycle, from implementation and testing to deployment and maintenance.
...
Figure \ref{fig:envs} illustrates the sequence of deployment environments, highlighting the progression from development to production and the isolation of each environment within the shared \ac{K8S} cluster.
